...
bool RootSignature::Init(
	...
	uint32_t maxCbvDescriptor,
	uint32_t maxSrvDescriptor,
...
bool RootSignature::Init(
	...
	rootSignatureDesc.Init_1_1(_countof(rootParameters), rootParameters, numSampler, pSamplerDescArray, rootSignatureFlags);
